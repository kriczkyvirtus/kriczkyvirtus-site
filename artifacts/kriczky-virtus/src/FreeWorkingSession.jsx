...
// ═══════════════════════════════════════════════════════════════════
// FREE WORKING SESSION — Booking Page
// URL: /free-session
//
// Purpose: Landing page for the "Book Your Free Working Session" CTA
// from the Resources hub "See The Gap" section. For owners who have
// explored the diagnostic tools and want clarity on their Profit Gap
// and Value Gap personalized to their business.
// ═══════════════════════════════════════════════════════════════════
...
export default function FreeWorkingSession() {
  ...
  useEffect(() => {
    ...
    const container = document.getElementById("iclosed-embed-session");
    if (!container) return;
      ...
      <div style={{ position: "relative", zIndex: 10, maxWidth: 900, margin: "0 auto", padding: mob ? "25px 20px 60px" : "25px 40px 80px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: mob ? 40 : 56 }}>
          ...
          <p style={{ fontSize: mob ? 14 : 16, lineHeight: 1.65, color: C.text2, maxWidth: 740, margin: "0 auto", fontWeight: 400 }}>
            Book a free working session and walk away knowing exactly how much money your business is leaving on the table — your Profit Gap — and the difference between your current valuation and what it could be — your Value Gap. This is yours to keep whether we ever work together or not.
          </p>
        </div>
        ...
        <div style={{ marginBottom: mob ? 40 : 56 }}>
          <div style={{ minHeight: 500, padding: mob ? "20px 16px" : "28px 32px", background: "linear-gradient(145deg, rgba(255,255,255,0.04), rgba(255,255,255,0.015) 50%, rgba(255,255,255,0.025))", border: `1px solid ${C.border2}`, borderTop: "1px solid rgba(255,255,255,0.10)", borderRadius: 18, boxShadow: `0 4px 12px rgba(0,0,0,0.3), 0 16px 48px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,0.06), 0 0 60px ${C.cyan}0a` }}>
            <div id="iclosed-embed-session" style={{ width: "100%" }}>

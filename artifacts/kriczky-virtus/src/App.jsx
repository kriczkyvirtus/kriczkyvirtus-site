                ...
                <div key={i} style={{
                  ...
                  <div style={{ maxHeight: isOpen ? 1200 : 0, opacity: isOpen ? 1 : 0, overflow: "hidden", transition: "max-height 0.5s cubic-bezier(0.4,0,0.2,1), opacity 0.4s ease" }}>
                    <div style={{ padding: mob ? "0 18px 22px" : "0 28px 28px" }}>
                      ...
                      {i === 0 && (
                        <div style={{ display: "flex", gap: mob ? 8 : 12, overflowX: mob ? "auto" : "hidden", overflowY: "hidden", paddingBottom: 8, paddingLeft: mob ? 0 : 70, paddingRight: mob ? 0 : 70 }}>
...
const TestimonialStrip = () => {
  ...
  return (
    <Section gradient={`radial-gradient(ellipse 60% 50% at 50% 50%,rgba(200,162,78,0.04) 0%,transparent 50%),linear-gradient(180deg,#090d14 0%,#0a0e15 50%,#090d14 100%)`} style={{ padding: mob ? "70px 0 120px" : "110px 0 210px", position: "relative", overflow: "visible" }}>
      ...
      <div style={{ position: "absolute", bottom: mob ? -70 : -100, left: "-10%", right: "-10%", height: mob ? 160 : 280, pointerEvents: "none", userSelect: "none", zIndex: 1, display: mob ? "none" : "flex", justifyContent: "center" }}>
              ...
              >
                ...
                <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", height: "100%" }}>
                  ...
                  <div style={{ marginTop: "auto" }}>
                    ...
                    <GoldBtn color={t.accent} style={{ width: "100%" }} onClick={t.ctaHref ? () => window.open(t.ctaHref, "_blank", "noopener,noreferrer") : onPrimary} arrowInset={18}>{t.cta}</GoldBtn>

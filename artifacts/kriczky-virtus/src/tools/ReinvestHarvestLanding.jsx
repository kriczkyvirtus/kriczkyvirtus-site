    ...
    <div style={{ background: C.bgDeep, minHeight: "100vh", fontFamily: "'DM Sans',sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      <div className="wrap" style={{ zIndex: 10 }}>
        ...
        <section style={{ padding: "34px 22px 30px", position: "relative", zIndex: 2, textAlign: "center" }}>
          ...
          <h1 style={{ ...H1, fontSize: "clamp(29px, 7vw, 44px)" }}>
          ...
          <p style={{ ...BODY, margin: "18px auto 0", maxWidth: 520, fontSize: 15 }}>
            Get it right and your business and financial freedom compound.<br />
            Get it wrong and you just get busier.
          </p>
        </section>

        {/* 2 — VIDEO */}
        <section style={{ padding: "0 22px 26px", position: "relative", zIndex: 2 }}>
        ...
        {/* 3 — PRIMARY CTA */}
        <section style={{ padding: "0 22px 30px", position: "relative", zIndex: 2 }}>
          <CTA />
        </section>

        {/* 4 — SAMPLE RESULT CARD (cycles through all four quadrants) */}
        <section style={{ padding: "0 22px 20px", position: "relative", zIndex: 2 }}>
          <SampleResultCard />
        </section>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            ...
            <div style={{ width: "100%", padding: "44px 24px 24px", background: `linear-gradient(135deg, ${C.gold}08, ${C.gold}03)`, border: `1px solid ${C.gold}25`, borderRadius: 14, textAlign: "center" }}>
              <div style={{ fontSize: 16, fontWeight: 700, color: C.text1 }}>
                Edward Kriczky, CEPA<sup style={{ fontSize: 10, top: "-.5em", position: "relative" }}>®</sup>
              </div>

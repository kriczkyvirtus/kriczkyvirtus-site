...
// ═══════════════════════════════════════════════════════════════════
// PARTNER QUALIFY — Booking Page
// URL: /partner-qualify
//
// Purpose: Landing page for the "See If You Qualify" CTA from the
// Clarity Partner and Growth Partner cards in the Pricing section.
// Embeds the iClosed scheduler inline.
// ═══════════════════════════════════════════════════════════════════
...
export default function PartnerQualify() {
  ...
  useEffect(() => {
    ...
    return () => {
      const el = document.getElementById("hide-sb-pq"); if (el) el.remove();
  ...
  const PARTNER_ITEMS = [
    {
      ...
      title: "This isn't consulting — it's help proactively executing",
      desc: "You get our team in your corner led by a dedicated advisor who knows your numbers, your constraints, and your goals. We work together helping you execute on the constraint for the business, not just talk about it.",
    },
    {
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={C.gold} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      title: "Monthly reviews, quarterly execution through 90-day sprints, bi-annual strategy half-days",
      desc: "Regular cadence of reviewing your numbers, prioritizing 1–3 decisions, assigning a 90-day action plan, and helping you execute on your core constraint at any given time — all prioritized by ROI potential.",
    },
    {
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={C.gold} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      title: "Guaranteed valuation growth",
      desc: "Our partner tiers come with conditional valuation growth guarantees backed by continued hands-on execution at no additional cost for a period of time. Conditions apply — discussed prior to working together.",
    },
    {
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={C.gold} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      title: "Full advisor team coordination",
      desc: "Your CPA, attorney, wealth advisor, M&A professionals, etc. — all rowing in the same direction. We coordinate so you can focus on running the business without worrying about conflicting advice or things falling through the cracks.",
    },
  ];
      ...
      <div style={{ position: "relative", zIndex: 10, maxWidth: 900, margin: "0 auto", padding: mob ? "25px 20px 60px" : "25px 40px 80px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: mob ? 40 : 56 }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 16px", borderRadius: 100, background: "rgba(200,162,78,0.08)", border: "1px solid rgba(200,162,78,0.20)", marginBottom: 20 }}>
            <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: mob ? 11 : 12, fontWeight: 600, color: C.gold, letterSpacing: 0.3 }}>Everything Starts With Quantifying How Much Money You Are Leaving on the Table</span>
          </div>
          <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 400, fontSize: mob ? 32 : 46, lineHeight: 1.1, letterSpacing: "-0.02em", color: C.text1, margin: "0 0 18px" }}>
            You Shouldn't Have to Guess<br /><span style={{ color: C.gold, fontStyle: "italic" }}>What Moves The Needle</span> for Your Business
          </h1>
          <p style={{ fontSize: mob ? 14 : 16, lineHeight: 1.65, color: C.text2, maxWidth: 680, margin: "0 auto", fontWeight: 400 }}>
            Most owners know the gaps exist — they just don't have someone in their corner to help systematically close them. This call is to see if having the Kriczky Virtus team as a "partner" in your corner is the right fit for where your business is today and where you want it to go.
          </p>
        </div>

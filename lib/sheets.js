...
async function ensureAggregatedRevenueBandColumn(sheets, spreadsheetId) {
...
async function appendLead({ name, email, tool, summary, answers, timestamp, blobUrl, utmSource, utmCampaign, businessName, revenueBand, revenueRange, businessConstraint, timeline, reason }) {
  ...
  if (tool === "reinvest-harvest") {
    try {
      ...
      aggregatedRow[revenueColumn.index - 1] = normalizedRevenueBand;
      ...
      aggregatedRow = [...baseAggregatedRow, normalizedRevenueBand];

...
async function appendLead({ name, email, tool, summary, answers, timestamp, blobUrl, utmSource, utmCampaign, businessName, revenueBand, revenueRange, ownership, tierInterest, businessConstraint, timeline, reason, firstName, lastName, phone, industry, ownerTier, timing, guess, scores, trackIntent }) {

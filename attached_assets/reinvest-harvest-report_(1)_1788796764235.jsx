...
const Page = ({ children, pageNum, total }) => (
  <div style={{
    ...
    <div style={{ position:"absolute", top:0, left:0, right:0, padding:"0.4in 0.6in 0.18in", display:"flex", justifyContent:"space-between", alignItems:"baseline", fontSize:9, letterSpacing:".16em", textTransform:"uppercase", color:C.text3, fontWeight:500, zIndex:5 }}>
...
export default function ReinvestHarvestReport({
  ...
  const [scores, setScores] = useState({ b1:5, b2:4, b3:5, b4:4, b5:6, p1:2, p2:3, p3:2, p4:3, p5:2 });
  ...
  return (
    <div style={{ background:C.bgDeep, minHeight:"100vh", paddingBottom:86 }}>
      ...
      <div className="bar" style={{ position:"fixed", bottom:0, left:0, right:0, zIndex:99, background:"rgba(10,14,20,.96)", backdropFilter:"blur(10px)",

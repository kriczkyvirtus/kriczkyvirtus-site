            ...
            <Page pageNum={++pageNum} allScored={allScored}>
              ...
              <div style={{ padding: "20px 24px", borderRadius: 12,
                ...
                <p style={{ fontSize: 13, color: C.text2, lineHeight: 1.6, marginBottom: 6 }}>
                  Email the word <span style={{ color: C.gold, fontWeight: 800, fontSize: 15, letterSpacing: "0.1em" }}>CONSTRAINT</span> to
                </p>
                ...
                <p style={{ fontSize: 10.5, color: C.text3, lineHeight: 1.55, maxWidth: 460, margin: "0 auto" }}>
                  We'll send you a personalized list of prioritized action steps based on your weakest dimensions — your full Business Independence Blueprint delivered to your inbox.
                </p>
              </div>
            </Page>
            <div className="page-gap" style={{ height: 24 }}/>
